...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $p_future_land_use_map_amendment_prop = isset($_POST['p_future_land_use_map_amendment_prop']) && $_POST['p_future_land_use_map_amendment_prop'] !== '' ? $_POST['p_future_land_use_map_amendment_prop'] : null;
    $p_PVA_parcel_number = isset($_POST['p_PVA_parcel_number']) && $_POST['p_PVA_parcel_number'] !== '' ? $_POST['p_PVA_parcel_number'] : null;
    $sql = "CALL sp_insert_future_land_use_map_application(?, ?, ?, ?, ?)";
    ...
    if (!$stmt) {
        ...
        $bind_names[] = &$p_future_land_use_map_amendment_prop;
...
<head>
  <meta charset="utf-8">
  <title>Future Land Use Map Application</title>
...
<div class="container py-4">
  <h1>Future Land Use Map Application</h1>
...
<div class="form-group">
    <label for="p_future_land_use_map_amendment_prop">Future Land Use Maamendment Prop</label>
    <input class="form-control" type="text" id="p_future_land_use_map_amendment_prop" name="p_future_land_use_map_amendment_prop">
</div>
<div class="form-group">
