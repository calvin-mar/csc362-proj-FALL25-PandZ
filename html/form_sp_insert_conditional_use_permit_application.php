...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $p_cupa_permit_request = isset($_POST['p_cupa_permit_request']) && $_POST['p_cupa_permit_request'] !== '' ? $_POST['p_cupa_permit_request'] : null;
    $p_cupa_proposed_conditions = isset($_POST['p_cupa_proposed_conditions']) && $_POST['p_cupa_proposed_conditions'] !== '' ? $_POST['p_cupa_proposed_conditions'] : null;
    ...
    if (!$stmt) {
        ...
        $bind_names[] = &$p_cupa_permit_request;
        $bind_names[] = &$p_cupa_proposed_conditions;
...
<div class="container py-4">
  <h1>Conditional Use Permit Application</h1>
...
<div class="form-group">
    <label for="p_cupa_permit_request">Cupa Permit Request</label>
    <input class="form-control" type="text" id="p_cupa_permit_request" name="p_cupa_permit_request">
</div>
<div class="form-group">
    <label for="p_cupa_proposed_conditions">Cupa Proposed Conditions</label>
    <input class="form-control" type="text" id="p_cupa_proposed_conditions" name="p_cupa_proposed_conditions">
</div>
