...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $p_va_variance_request = isset($_POST['p_va_variance_request']) && $_POST['p_va_variance_request'] !== '' ? $_POST['p_va_variance_request'] : null;
    $p_va_proposed_conditions = isset($_POST['p_va_proposed_conditions']) && $_POST['p_va_proposed_conditions'] !== '' ? $_POST['p_va_proposed_conditions'] : null;
    ...
    if (!$stmt) {
        ...
        $bind_names[] = &$p_va_variance_request;
        $bind_names[] = &$p_va_proposed_conditions;
...
<div class="form-group">
    <label for="p_va_variance_request">Va Variance Request</label>
    <input class="form-control" type="text" id="p_va_variance_request" name="p_va_variance_request">
</div>
<div class="form-group">
    <label for="p_va_proposed_conditions">Va Proposed Conditions</label>
    <input class="form-control" type="text" id="p_va_proposed_conditions" name="p_va_proposed_conditions">
</div>
<div class="form-group">
